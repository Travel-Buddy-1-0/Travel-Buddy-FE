...
function LoginSuccessMessage() {
  return (
    <div className="mt-4 p-3 rounded-md bg-green-100 border border-green-400 text-green-700 text-sm font-medium">
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(true);   // bật thông báo success
      setError(null);

      // đợi 1s rồi chuyển trang
      setTimeout(() => {
        navigate("/");
      }, 1000);
    } catch (err) {
    ...
    <div className="w-full max-w-sm">
      ...
      <form className="space-y-5 mt-10" onSubmit={handleSubmit}>
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <a href="forgetPassword" className="text-blue-500 font-medium hover:underline">
            Forgot password?
          </a>
        </div>
